...
public class IndexListAdapterCompany extends BaseAdapter {

    ArrayList<String> arrayList;
    Context context;
    LayoutInflater inflater;

    public IndexListAdapterCompany(Context context, ArrayList<String> arrayList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        IndexListAdaptor.MyViewHolder myViewHolder;
        if(convertView == null){
            convertView = inflater.inflate(R.layout.index_list_layout,null);
            myViewHolder = new IndexListAdaptor.MyViewHolder(convertView);
            convertView.setTag(myViewHolder);
        }else{
            myViewHolder = (IndexListAdaptor.MyViewHolder) convertView.getTag();
        }
        JSONObject obj=null;
        try {
